...
import { Globe, Megaphone, Clock, Bell } from "lucide-react";
                        ...
                        {announcements.length > 0 && (
                            <div className="mb-4">
                                ...
                                {announcements.map((announcement, index) => (
                                    <div
                                        key={index}
                                        className="bg-gradient-to-r from-[rgb(253,253,253)] to-[rgb(131,194,199)] p-4 mb-2 rounded-lg shadow transition-transform duration-300 hover:shadow-lg hover:scale-105"
                                    >
